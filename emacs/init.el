...
(progn
  ...
  (keymap-global-set "M-s a" #'align-regexp)
  (keymap-global-set "M-s c" #'comment-or-uncomment-region)
  (keymap-global-set "M-s r" #'replace-regexp)
  (keymap-global-set "M-s s" #'sort-lines)
  (keymap-global-set "<f2> <f2>" #'compile)
  (keymap-global-set "<f2> <f3>" #'recompile)
  (keymap-global-set "M-<f2>" #'recompile)
  (keymap-global-set "M-s M-s" #'shell)
  (keymap-global-set "C-x C-k" #'kill-buffer)
  (keymap-global-set "C-x M-b" #'eval-buffer))
